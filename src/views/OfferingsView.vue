    ...
    <div class="main-layout">
        ...
        <main>
            ...
            <section>
                <div class="section-wrapper">
                    <div class="vertical-offset">
                        <p><b>I offer 3 different kinds of 1-on-1 sessions.</b></p>

                        <p>I invite you to read about these session options first. A more in-depth definition of each modality is then provided below.</p>
                    </div>

                    <h3>1. Somatic Experiencing (Virtual and In-Person):</h3>
                    ...
                    <h3>3. Trauma-Informed Reiki (Virtual and In-Person):</h3>
            ...
            <section class="primary" id="reiki">
                <div class="section-wrapper">
                    <h3>Reiki</h3>
                    <p>Reiki is a form of hands-on (or distance) energy healing that originated in Japan, that brings relief from suffering and supports overall health.</p>
